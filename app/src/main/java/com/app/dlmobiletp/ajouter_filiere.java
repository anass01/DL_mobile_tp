...
public class ajouter_filiere extends AppCompatActivity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ajouter_filiere);
        ListView lv =(ListView)findViewById(R.id.lv_fil);
        final DatabaseHelper dbHelper = new DatabaseHelper(this);
        loadlv(dbHelper);
        final TextView txtcode=(TextView) findViewById(R.id.txt_code);
        final TextView libelle=(TextView) findViewById(R.id.txt_libelle);
        Button btn_af= (Button)findViewById(R.id.Btn_ajouter);
        btn_af.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                long newRowId = dbi.insert("fil", null, values);
                dbi.close();
                txtcode.setText("");
                libelle.setText("");
                loadlv(dbHelper);
